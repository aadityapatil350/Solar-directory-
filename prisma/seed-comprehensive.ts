...
const additionalListings = [
  ...
  { name: 'Chennai Solar Service', slug: 'chennai-service-1', description: 'Tamil Nadu maintenance.', phone: '+91 98765 50045', email: null, website: null, address: null, verified: false, featured: false, rating: 4.0, reviews: Math.floor(Math.random() * 30) + 20, categoryIndex: 4, cityIndex: 5 },
